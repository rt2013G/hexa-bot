...
class User():
    def __init__(self, user_data: tuple) -> None:
        ...
        self.username: str = None if user_data[1] is None else user_data[1].decode("utf-8")
        self.first_name: str = None if user_data[2] is None else user_data[2].decode("utf-8")
        self.last_name: str = None if user_data[3] is None else user_data[3].decode("utf-8")
